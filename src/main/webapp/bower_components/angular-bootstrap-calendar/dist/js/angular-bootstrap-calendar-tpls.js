!function (e, n) {
    ...
    return function (e) {
        ...
        "use strict";
        var a = t(12);
        a.module("mwl.calendar").controller("MwlCalendarCtrl", ["$scope", "$log", "$timeout", "$attrs", "$locale", "moment", "calendarTitle", "calendarHelper", function (e, n, t, l, i, d, s, o) {
            function v() {
            ...
            c.events = c.events || [], c.changeView = function (e, n) {
                ...
                var n = d(e).toDate(), t = {year: "month", month: "day", week: "day"};
                c.onViewChangeClick({calendarDate: n, calendarNextView: t[c.view]}) !== !1 && c.changeView(t[c.view], n)
            };
        ...
        a.module("mwl.calendar").factory("calendarHelper", ["$q", "$templateRequest", "dateFilter", "moment", "calendarConfig", "$filter", function (e, n, t, a, l, i) {
            ...
            function h(e, n, t, l, d) {
                for (var s = a(n).startOf("month"), o = s.clone().startOf("week"), v = a(n).endOf("month").endOf("week"), r = [], c = a().startOf("day"); o.isBefore(v);) {
                    var m = o.month() === a(n).month(), w = !1, p = i("date")(new Date(o.clone()), "dd-MM-yyyy"), h = [];
                    for (var g in l)i("date")(new Date(l[g].plannedStartTime), "dd-MM-yyyy") == p && ("month" == d && h.push(l[g]), w = !0);
                    var f = {
                        label: o.date(),
                        date: o.clone(),
                        hours: h,
