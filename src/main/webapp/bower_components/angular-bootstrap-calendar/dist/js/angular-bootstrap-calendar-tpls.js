!function (e, n) {
    ...
    return function (e) {
        ...
        a.module("mwl.calendar").controller("MwlCalendarCtrl", ["$scope", "$log", "$timeout", "$attrs", "$locale", "moment", "calendarTitle", "calendarHelper", function (e, n, t, i, l, r, d, o) {
            ...
            function s() {
                d[v.view] && a.isDefined(i.viewTitle) && (v.viewTitle = d[v.view](v.viewDate));
            ...
            o.loadTemplates().then(function () {
                ...
                e.$watchGroup(["vm.viewDate", "vm.view", "vm.cellIsOpen", function () {
                    ...
                    n ? s() : (n = !0, e.$watch("vm.planItems", c, !0))
                })
            })["catch"](function (e) {
        ...
        a.module("mwl.calendar").factory("calendarHelper", ["$q", "$templateRequest", "dateFilter", "moment", "calendarConfig", "$filter", function (e, n, t, a, i, l) {
            ...
            function c(e, n, t) {
                return e.filter(function (e) {
                    return console.log("e " + e), s(e, n, t)
                })
            }
            ...
            function f(e, n, t) {
                for (var l = [], d = v(n, "year", e), o = a(n).startOf("year"), s = 0; 12 > s;) {
                    var u = o.clone(), f = u.clone().endOf("month"), w = c(d, u, f), p = {
                    ...
                    t({calendarCell: p}), l.push(p), o.add(1, "month"), s++
                }
                return l
            }
            ...
            function w(e, n, t, i, vp) {
                ...
                for (var r = a(n).startOf("month"), d = r.clone().startOf("week"), o = a(n).endOf("month").endOf("week"), s = [], c = a().startOf("day"); d.isBefore(o);) {
                    ...
                    for (var index in i) {
                        if (l("date")(new Date(i[index].plannedStartTime), "dd-MM-yyyy") == u) {
                            if (vp == 'month') hours.push(i[index]);
                            m = !0;
                        }
                    }
                    ...
                    var f = {
                        ...
                        isPast: c.isAfter(d),
                        isToday: c.isSame(d),
                        isFuture: c.isBefore(d),
                        isWeekend: [0, 6].indexOf(d.day()) > -1
                    };
                    t({calendarCell: f}), s.push(f), d.add(1, "day")
                }
                return s
            }
            ...
            function h(e, n, t, i, l) {
                var r = a(t || "00:00", "HH:mm").hours(), d = a(i || "23:00", "HH:mm").hours(), o = 60 / l * 30, v = a(n).startOf("day").add(r, "hours"), m = a(n).startOf("day").add(d + 1, "hours"), u = (d - r + 1) * o, f = o / 60, w = [], p = c(e, a(n).startOf("day").toDate(), a(n).endOf("day").toDate());
                return p.map(function (e) {
                    ...
                    return w.forEach(function (t, a) {
                        ...
                        }), i && n && (n = !1, e.left = 150 * a, w[a].push(e))
                    }), n && (e.left = 150 * w.length, w.push([e])), e
                })
            }
        ...
        "use strict";
        var a = t(12), i = t(50);
        i.locale("en_gb", {week: {dow: 1}}), a.module("mwl.calendar").constant("moment", i)
    }, function (e, n) {
        e.exports = t
    }])
});
