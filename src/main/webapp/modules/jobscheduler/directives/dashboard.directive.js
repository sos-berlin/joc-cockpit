                    ...
                    function drawFlow() {
                        ...
                        angular.forEach(scope.clusterStatusData.supervisors, function (supervisor, sIndex) {
                            ...
                            template = template + ' <div class="cluster-rect" data-toggle="popover"  trigger="hover" data-content="' + popoverTemplate + '"' +
                                ...
                                '<a class="hide dropdown-item bg-hover-color" ng-click="action1(\'' + sIndex + '\',\'undefined\',\'terminate\')" ng-class="{\'show\':permission.JobschedulerMaster.execute.terminate,\'disable-link\':clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'RUNNING\' && clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'WAITING_FOR_ACTIVATION_PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'WAITING_FOR_ACTIVATION\'}" id="' + '__supervisor,terminate,' + supervisor.host + ':' + supervisor.port + '" translate>button.terminate</a>' +
                                ...
                                '<a class="hide dropdown-item" ng-click="action1(\'' + sIndex + '\',\'undefined\',\'abort\')" ng-class="{\'show\':permission.JobschedulerMaster.execute.abort,\'disable-link\':clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'RUNNING\' && clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'WAITING_FOR_ACTIVATION_PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'WAITING_FOR_ACTIVATION\'}"  id="' + '__supervisor,abort,' + supervisor.host + ':' + supervisor.port + '" translate>button.abort</a>' +
                                '<a class="hide dropdown-item" ng-click="action1(\'' + sIndex + '\',\'undefined\',\'abortAndRestart\')" ng-class="{\'show\':permission.JobschedulerMaster.execute.restart.abort,\'disable-link\':clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'RUNNING\' && clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'WAITING_FOR_ACTIVATION_PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'WAITING_FOR_ACTIVATION\'}" id="' + '__supervisor,abortAndRestart,' + supervisor.host + ':' + supervisor.port + '" translate>button.abortAndRestart</a>' +
                                '<a class="hide dropdown-item" ng-click="action1(\'' + sIndex + '\',\'undefined\',\'terminateAndRestart\')" ng-class="{\'show\':permission.JobschedulerMaster.execute.restart.terminate,\'disable-link\':clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'RUNNING\' && clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'WAITING_FOR_ACTIVATION_PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'WAITING_FOR_ACTIVATION\'}" id="' + '__supervisor,terminateAndRestart,' + supervisor.host + ':' + supervisor.port + '" translate>button.terminateAndRestart</a>' +
                                ...
                                '<a class="hide dropdown-item" ng-click="action1(\'' + sIndex + '\',\'undefined\',\'pause\')" ng-class="{show:clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'WAITING_FOR_ACTIVATION_PAUSED\' && permission.JobschedulerMaster.execute.pause, \'disable-link\':clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'RUNNING\' && clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'WAITING_FOR_ACTIVATION\'}" id="' + '__supervisor,pause,' + supervisor.host + ':' + supervisor.port + '" translate>button.pause</a>' +
                                '<a class="hide dropdown-item" ng-click="action1(\'' + sIndex + '\',\'undefined\',\'continue\')" ng-class="{show:(clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text==\'PAUSED\' || clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text==\'WAITING_FOR_ACTIVATION_PAUSED\') && permission.JobschedulerMaster.execute.continue}"  id="' + '__supervisor,continue,' + supervisor.host + ':' + supervisor.port + '" translate>button.continue</a>' +
                                ...
                                '<a class="hide dropdown-item" ng-click="action1(\'' + sIndex + '\',\'undefined\',\'downloadLog\')" ng-class="{show:clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'RUNNING\' && permission.JobschedulerMaster.view.mainlog,\'disable-link\': clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'WAITING_FOR_ACTIVATION_PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].data.state._text!=\'WAITING_FOR_ACTIVATION\'}" id="' + '__supervisor,download_log,' + supervisor.host + ':' + supervisor.port + '" translate>button.downloadLog</a>' +
                            ...
                            angular.forEach(supervisor.masters, function (master, index) {
                                ...
                                masterTemplate = '<div data-toggle="popover"   data-content=\'' + popoverTemplate + '\'' +
                                    ...
                                    '<div class="dropdown-menu dropdown-ac dropdown-more list-dropdown">' +
                                    '<a class="hide dropdown-item bg-hover-color" ng-click="action1(\'' + sIndex + '\',\'' + index + '\',\'terminate\')" ng-class="{\'show\':permission.JobschedulerMaster.execute.terminate,\'disable-link\':clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'RUNNING\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION_PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION\'}" id="' + '__master,terminate,' + master.host + ':' + master.port + '" translate>button.terminate</a>' +
                                    ...
                                    '<a class="hide dropdown-item" ng-click="action1(\'' + sIndex + '\',\'' + index + '\',\'abort\')" ng-class="{\'show\':permission.JobschedulerMaster.execute.abort,\'disable-link\':clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'RUNNING\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION_PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION\'}" id="' + '__master,abort,' + master.host + ':' + master.port + '" translate>button.abort</a>' +
                                    '<a class="hide dropdown-item" ng-click="action1(\'' + sIndex + '\',\'' + index + '\',\'abortAndRestart\')" ng-class="{\'show\':permission.JobschedulerMaster.execute.restart.abort,\'disable-link\':clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'RUNNING\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION_PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION\'}" id="' + '__master,abortAndRestart,' + master.host + ':' + master.port + '" translate>button.abortAndRestart</a>' +
                                    '<a class="hide dropdown-item" ng-click="action1(\'' + sIndex + '\',\'' + index + '\',\'terminateAndRestart\')" ng-class="{\'show\':permission.JobschedulerMaster.execute.restart.terminate,\'disable-link\':clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'RUNNING\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION_PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION\'}" id="' + '__master,terminateAndRestart,' + master.host + ':' + master.port + '" translate>button.terminateAndRestart</a>' +
                                    ...
                                    '<a class="hide dropdown-item" ng-click="action1(\'' + sIndex + '\',\'' + index + '\',\'pause\')" ng-class="{\'disable-link\':clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'RUNNING\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION\',show:clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION_PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION_PAUSED\' && permission.JobschedulerMaster.execute.pause}"  id="' + '__master,pause,' + master.host + ':' + master.port + '" translate>button.pause</a>' +
                                    '<a class="hide dropdown-item" ng-click="action1(\'' + sIndex + '\',\'' + index + '\',\'continue\')" ng-class="{\'show\': (clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text==\'PAUSED\' || clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text==\'WAITING_FOR_ACTIVATION_PAUSED\') && permission.JobschedulerMaster.execute.continue}"  id="' + '__master,continue,' + master.host + ':' + master.port + '" translate>button.continue</a>' +
                                    ...
                                    '<a class="hide dropdown-item" ng-click="action1(\'' + sIndex + '\',\'' + index + '\',\'downloadLog\')" ng-class="{\'disable-link\':clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'RUNNING\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION_PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION\',show:permission.JobschedulerMaster.view.mainlog }" id="' + '__master,download_log,' + master.host + ':' + master.port + '" translate>button.downloadLog</a>' +
                                    '<a class="hide dropdown-item" ng-click="action1(\'' + sIndex + '\',\'' + index + '\',\'downloadDebugLog\')" ng-class="{\'disable-link\':clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'RUNNING\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION_PAUSED\' && clusterStatusData.supervisors[\'' + sIndex + '\'].masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION\',show:permission.JobschedulerMaster.view.mainlog }" id="' + '__master,download_log,' + master.host + ':' + master.port + '" translate>button.downloadDebugLog</a>' +
                                    '</div></div>' +
                                    '</span></div>';
                                if (master.os) {
                        ...
                        angular.forEach(scope.clusterStatusData.members.masters, function (master, index) {
                            if (master) {
                                ...
                                var masterTemplate = '<div data-toggle="popover"   data-content=\'' + popoverTemplate + '\'' +
                                    ...
                                    '<a class="hide dropdown-item" ng-click="action1(\'undefined\',\'' + index + '\',\'pause\')" ng-class="{\'disable-link\':clusterStatusData.members.masters[\'' + index + '\'].state._text!=\'RUNNING\' && clusterStatusData.members.masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION\',show:permission.JobschedulerMaster.execute.pause && clusterStatusData.members.masters[\'' + index + '\'].state._text!=\'PAUSED\' && clusterStatusData.members.masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION_PAUSED\'}"  id="' + '__master,pause,' + master.host + ':' + master.port + '" translate>button.pause</a>' +
                                    '<a class="hide dropdown-item" ng-click="action1(\'undefined\',\'' + index + '\',\'continue\')" ng-class="{\'show\':permission.JobschedulerMaster.execute.continue && (clusterStatusData.members.masters[\'' + index + '\'].state._text==\'PAUSED\' || clusterStatusData.members.masters[\'' + index + '\'].state._text==\'WAITING_FOR_ACTIVATION_PAUSED\')}"  id="' + '__master,continue,' + master.host + ':' + master.port + '" translate>button.continue</a>' +
                                    ...
                                    '<a class="hide dropdown-item" ng-click="action1(\'undefined\',\'' + index + '\',\'downloadDebugLog\')"  ng-class="{\'disable-link\':clusterStatusData.members.masters[\'' + index + '\'].state._text!=\'RUNNING\' && clusterStatusData.members.masters[\'' + index + '\'].state._text!=\'PAUSED\' && clusterStatusData.members.masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION_PAUSED\' && clusterStatusData.members.masters[\'' + index + '\'].state._text!=\'WAITING_FOR_ACTIVATION\',show:permission.JobschedulerMaster.view.mainlog }" id="' + '__master,download_log,' + master.host + ':' + master.port + '" translate>button.downloadDebugLog</a>' +
                                    '</div></div>' +
                                    '</span></div>';
                                if (master.os) {
                                    masterTemplate = masterTemplate + '<div class="text-left p-t-xs p-l-sm block-ellipsis-cluster"><i class="fa fa-' + master.os.name.toLowerCase() + '"></i><span class="p-l-sm text-sm" title="' + master.jobschedulerId + '">' + master.jobschedulerId +
            ...
            controller: ["$scope", "$interval", function ($scope, $interval) {
                ...
                function drawConnections() {
                    ...
                    function drawForRemainings() {
                        ...
                        angular.forEach(vm.clusterStatusData.members.masters, function (master, index) {
                            ...
                            node.style.setProperty('width', dLeft - mLeft - sWidth / 2 + 'px');
                            node.setAttribute('ng-style', '{"border":(clusterStatusData.members.masters[\'' + index + '\'].state._text==\'UNREACHABLE\'?\'1px dashed #f44455\': \'1px dashed #D9D9D9\')}');
                            clusterStatusContainer.appendChild(node);
                            $compile(node)(vm);
                            ...
                            clusterStatusContainer.appendChild(node);
                            $compile(node)(vm);
                            let dom = $("#clusterStatusContainer");
                            if(dom.parents('.grid-stack') && dom.parents('.grid-stack')[0]){
                                let ht = $(dom.parents('.grid-stack-item')[0]).height();
                                ht = parseInt(ht);
                                if(ht > 100){
                                    dom.css({height: (ht - 48)+'px'});
                                }
                            }
                        })
                    }
                ...
                vm.$on('event-started', function (event, args) {
                    if (args.otherEvents && args.otherEvents.length > 0) {
                        for (let j = 0; j < args.otherEvents.length; j++) {
                            let flag = false;
                            if (args.otherEvents[j].eventSnapshots && args.otherEvents[j].eventSnapshots.length > 0)
                                for (let x = 0; x < args.otherEvents[j].eventSnapshots.length; x++) {
