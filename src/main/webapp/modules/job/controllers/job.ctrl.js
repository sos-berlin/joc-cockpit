...
(function () {
    ...
    JobWorkflowCtrl.$inject = ["$scope", "$rootScope", "$uibModal", "CoreService", "ConditionService"];
    function JobWorkflowCtrl($scope, $rootScope, $uibModal, CoreService, ConditionService) {
        const vm = $scope;
        vm.jobFilters = CoreService.getJobTab();
