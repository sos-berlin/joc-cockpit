...
(function () {
    ...
    function RuntimeEditorDialogCtrl($scope, $uibModalInstance, toasty, $timeout) {
        ...
        vm.removePeriod = function (period, index) {
            ...
            if (period.every == 'weekDays') {
                if (period.tab == "specificWeekDays") {
                    ...
                    console.log(vm.tempRunTime.weekdays)
                ...
                console.log(vm.tempRunTime.ultimos)
        ...
        vm.back = function(){
            vm.editor.hidePervious = false;editor.nextPage =false;
            vm.periodList = [];
        };
        vm.next = function(){
