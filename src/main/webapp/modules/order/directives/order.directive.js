                        ...
                        angular.forEach(vm.jobChainData.nodes, function (item, index) {
                            ...
                            btn1.addEventListener('click', function () {
                                if (item.job.path) {
                                    ...
                                    } else if (btn1.textContent.trim() == gettextCatalog.getString('button.unstopNode')) {
                                        vm.onAction({
                                            path: jobChainPath,
                                            node: item.name,
                                            action: 'unstop node'
                            ...
                            btn2.addEventListener('click', function () {
                                if (item.job.path) {
                                    ...
                                    } else if (btn2.textContent.trim() == gettextCatalog.getString('button.unskipNode')) {
                                        vm.onAction({
                                            path: jobChainPath,
                                            node: item.name,
                                            action: 'unskip'
                            ...
                            btn5.addEventListener('click', function () {
                                if (item.job.path) {
                                    ...
                                    } else if (btn5.textContent.trim() == gettextCatalog.getString('button.unstopNode')) {
                                        vm.onAction({
                                            path: jobChainPath,
                                            node: item.name,
                                            action: 'unstop node'
                            ...
                            btn6.addEventListener('click', function () {
                                if (item.job.path) {
                                    ...
                                    } else if (btn6.textContent.trim() == gettextCatalog.getString('button.unskipNode')) {
                                        vm.onAction({
                                            path: jobChainPath,
                                            node: item.name,
                                            action: 'unskip'
                            ...
                            if (navigateToJobBtn)
                                navigateToJobBtn.addEventListener('click', function () {
