                            ...
                            angular.forEach(orders, function (order, index) {
                                ...
                                function getOrderMenu(order, nodeName) {
                                    ...
                                    var menu = '<span class="text-sm"><i id="circle-' + order.orderId + '" class="text-xs fa fa-circle" ng-class="colorFunction(\'' + order.processingState.severity + '\')"></i> ' +
                                        ...
                                        + '<a class="hide" id="runtime-' + order.orderId + '" ng-class="{\'show dropdown-item\':(\'' + order.processingState + '\'&& (\'' + order.processingState._text + '\'== \'SUSPENDED\' ||\'' + order.processingState._text + '\'== \'PENDING\'))&& permission.Order.change.runTime}">' + gettextCatalog.getString("button.setRunTime") + '</a>'
                                        + '<a class="hide" id="resetruntime-' + order.orderId + '" ng-class="{\'show dropdown-item\':(\'' + order.processingState + '\'&& (\'' + order.processingState._text + '\'== \'SUSPENDED\' ||\'' + order.processingState._text + '\'== \'PENDING\'))&& permission.Order.change.runTime, \'disable-link\':\''+order.runTimeIsTemporary+'\' == \'false\'}">' + gettextCatalog.getString("button.resetRunTime") + '</a>'
