...
import {
  ...
  ResizableDirective,
  AutofocusDirective,
  TimeValidatorDirective, TimeRegexValidator, RelativeDateValidator
...
const DIRECTIVES = [TimeValidatorDirective, TimeRegexValidator, RegexValidator, RelativeDateValidator, ResizableDirective,
