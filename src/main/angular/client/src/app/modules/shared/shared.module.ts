...
const DIRECTIVES = [TimeValidatorDirective,TimeDurationValidatorDirective,TimeValidatorReqexDirective, TimeRegexValidator, NegativeTimeRegexValidator, RegexValidator, RelativeDateValidator,
