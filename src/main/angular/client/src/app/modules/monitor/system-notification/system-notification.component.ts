...
export class SystemNotificationComponent {
  ...
  constructor(public coreService: CoreService, private authService: AuthService, private router: Router, private orderPipe: OrderPipe,
              ...
              private translate: TranslateService, private excelService: ExcelService,  private clipboardService: ClipboardService, private cdr: ChangeDetectorRef) {
  ...
  private getData(): void {
    ...
    obj.categories = this.filters.filter.categories == 'ALL' ? ['JOC', 'SYSTEM', 'CONTROLLER', 'AGENT'] : [this.filters.filter.categories];
