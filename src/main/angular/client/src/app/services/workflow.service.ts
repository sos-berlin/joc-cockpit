...
export class WorkflowService {
  ...
  <defs>
    ...
    <linearGradient id="e" x1="128" x2="128" y1="8.4831" y2="247.52" gradientTransform="matrix(.14456 0 0 .14456 -.85197 -.85197)" gradientUnits="userSpaceOnUse">
      <stop stop-color="${fillColor}" offset="0"/>
...
<g transform="scale(0.9)" transform-origin="center">
  ...
  <g transform="scale(0.9)" transform-origin="center">
    ...
    <path d="m16.863 16.426c0-0.35938 0.29297-0.65625 0.65625-0.65625s0.65625 0.29688 0.65625 0.65625v3.1094l2.3008 2.4609c0.25 0.26562 0.23438 0.67969-0.03125 0.92578-0.26562 0.25-0.67969 0.23438-0.92578-0.03125l-2.4336-2.6016c-0.14063-0.14844-0.21875-0.34375-0.22266-0.54687z" fill="${color}"/>
      ...
      svg = '<svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">\n' +
        '<path fill-rule="evenodd" clip-rule="evenodd" d="M14.2199 1.35765L23.5047 10.6424C24.2545 11.3922 24.2545 12.6078 23.5047 13.3576L14.2199 22.6424C13.4701 23.3922 12.2545 23.3922 11.5047 22.6424L2.21995 13.3576C1.47014 12.6078 1.47014 11.3922 2.21995 10.6424L11.5047 1.35765C12.2545 0.607838 13.4701 0.607838 14.2199 1.35765Z" stroke="black" stroke-width="0.5"/>\n' +
        '<path d="M15.3222 14.875C15.4556 15.15 15.5255 15.4481 15.5289 15.75H10.1956C10.1995 15.4474 10.2722 15.1491 10.409 14.875C10.5473 14.5936 10.7526 14.3456 11.0089 14.15L12.2223 13.2C12.4091 13.0532 12.5593 12.8697 12.6623 12.6625C12.7689 12.4563 12.8229 12.2294 12.8223 12H12.9023C12.9116 12.2313 12.9776 12.4588 13.0956 12.6625C13.1962 12.8675 13.3442 13.0488 13.5289 13.1938L14.7156 14.15C14.9722 14.3469 15.1796 14.5938 15.3222 14.875ZM9.65897 16.9025C9.8123 16.9675 9.97385 17 10.1436 17H15.5809C15.7542 16.9967 15.9175 16.9642 16.0709 16.9025C16.2233 16.84 16.3586 16.7521 16.4769 16.6388C16.5951 16.525 16.6889 16.3965 16.7582 16.2531C16.8275 16.1094 16.8622 15.9579 16.8622 15.7988C16.8622 15.5417 16.8326 15.2927 16.7735 15.0519C16.7148 14.8121 16.6311 14.5782 16.5235 14.3538C16.4168 14.1297 16.2823 13.9183 16.1229 13.7238C15.9606 13.526 15.7755 13.3458 15.5709 13.1863L14.3576 12.2394C14.32 12.2103 14.2897 12.1737 14.2689 12.1323C14.2482 12.0909 14.2374 12.0458 14.2374 12C14.2374 11.9543 14.2482 11.9091 14.2689 11.8677C14.2897 11.8264 14.32 11.7898 14.3576 11.7606L15.5709 10.8088C15.9815 10.4927 16.3108 10.0938 16.5342 9.64191C16.7543 9.18988 16.8663 8.69818 16.8622 8.20129C16.8611 8.04424 16.8264 7.88899 16.7603 7.74471C16.6941 7.60043 16.5977 7.47006 16.4769 7.36129C16.3568 7.25202 16.2177 7.16282 16.0655 7.09754C15.9136 7.03191 15.7481 6.99862 15.5809 7.00004H10.1436C9.9703 7.00296 9.80719 7.03546 9.6543 7.09754C9.50097 7.16004 9.36542 7.24796 9.24764 7.36129C9.13109 7.47385 9.03594 7.60427 8.96631 7.74692C8.89698 7.89067 8.86231 8.04212 8.86231 8.20129C8.86587 8.71545 8.97698 9.19566 9.19564 9.64191C9.41871 10.0928 9.7462 10.4915 10.1543 10.8088L11.3676 11.7606C11.4051 11.7899 11.4353 11.8264 11.456 11.8678C11.4767 11.9092 11.4874 11.9543 11.4874 12C11.4874 12.0457 11.4767 12.0909 11.456 12.1322C11.4353 12.1736 11.4051 12.2102 11.3676 12.2394L10.1543 13.1863C9.95022 13.3484 9.76498 13.5302 9.60163 13.7288C9.28104 14.1206 9.05701 14.5742 8.94564 15.0569C8.88975 15.3007 8.86182 15.5494 8.86231 15.7988C8.86587 15.9613 8.90053 16.1144 8.96631 16.2581C9.03298 16.401 9.12675 16.5279 9.24764 16.6388C9.36897 16.7496 9.50608 16.8375 9.65897 16.9025ZM15.7995 16.3313C15.7216 16.3601 15.6386 16.375 15.5549 16.375H10.1696C10.0837 16.374 9.99883 16.3575 9.91963 16.3263C9.8441 16.2961 9.77516 16.253 9.7163 16.1994C9.65604 16.1456 9.60837 16.0807 9.5763 16.0088C9.5447 15.9344 9.52864 15.855 9.52897 15.775C9.53036 15.3734 9.62451 14.9768 9.80496 14.6125C9.9853 14.2481 10.2505 13.9263 10.581 13.6706L11.7943 12.7181C11.9089 12.6273 11.9976 12.52 12.0603 12.3963C12.1221 12.2717 12.1541 12.1359 12.1541 11.9985C12.1541 11.861 12.1221 11.7253 12.0603 11.6006C11.9999 11.475 11.9088 11.3645 11.7943 11.2782L10.581 10.3307C10.4134 10.2034 10.263 10.0575 10.133 9.89628C10.0067 9.73705 9.89684 9.56691 9.80496 9.38816C9.71168 9.2079 9.64185 9.01779 9.59697 8.82191C9.5517 8.626 9.52891 8.42612 9.52897 8.22566C9.53252 8.13816 9.54986 8.06004 9.58097 7.99129C9.61208 7.92296 9.65719 7.85942 9.7163 7.80067C9.77364 7.74418 9.84288 7.69948 9.91963 7.66942C9.99894 7.63979 10.0836 7.62473 10.169 7.62504H15.5542C15.6475 7.63129 15.7309 7.64754 15.8042 7.67379C15.8775 7.70004 15.9453 7.74233 16.0075 7.80067C16.0673 7.85627 16.1147 7.9225 16.1469 7.99547C16.179 8.06845 16.1954 8.1467 16.1949 8.22566C16.1952 8.62889 16.101 9.02725 15.9189 9.39253C15.738 9.75533 15.4728 10.0756 15.1429 10.33L13.9296 11.2775C13.8149 11.365 13.7262 11.4723 13.6636 11.5994C13.6017 11.7241 13.5696 11.86 13.5696 11.9975C13.5696 12.1351 13.6017 12.2709 13.6636 12.3956C13.7262 12.5194 13.8149 12.6267 13.9296 12.7175L15.1429 13.67C15.4829 13.9367 15.7433 14.2508 15.9242 14.6125C16.1047 14.9738 16.1949 15.3613 16.1949 15.775C16.1899 15.8549 16.1724 15.9337 16.1429 16.0088C16.1122 16.0803 16.0661 16.1452 16.0075 16.1994C15.9475 16.2551 15.8767 16.2997 15.7989 16.3306" fill="black"/>\n' +
        '</svg>'
    } else if (name === 'prompt') {
    ...
    symbol.fontSize = '12';
    symbol.align = 'center';
    if (name.match('try') || name == 'job' || name.match('if') || name.match('when') || name.match('caseWhen') || name.match('cycle') || name.match('elseWhen')) {
  ...
  static setStyleToVertex(name: string, colorCode: string, theme: string, graph: any = null): any {
    ...
    if (name === 'if' || name === 'when' || name === 'caseWhen' || name === 'cycle' || name === 'elseWhen' || name.match('try')) {
  ...
  <defs>
    ...
    <linearGradient id="e" x1="128" x2="128" y1="8.4831" y2="247.52" gradientTransform="matrix(.14456 0 0 .14456 -.85197 -.85197)" gradientUnits="userSpaceOnUse">
      <stop stop-color="${fillColor}" offset="0"/>
      <stop stop-color="${fillColor}" offset="1"/>
    </linearGradient>
    <clipPath id="a"><rect width="35" height="35"/></clipPath>
  </defs>
...
<g transform="scale(0.9)" transform-origin="center">
  ...
  init(theme: string, graph: any, colorCode: any = null): void {
    ...
    WorkflowService.setStyleToSymbol('sleep', colorCode, theme, graph);
    ...
    WorkflowService.setStyleToVertex('when', colorCode, theme, graph);
    WorkflowService.setStyleToVertex('cycle', colorCode, theme, graph);
    WorkflowService.setStyleToVertex('elseWhen', colorCode, theme, graph);
    WorkflowService.setStyleToVertex('retry', colorCode, theme, graph);
    WorkflowService.setStyleToVertex('try', colorCode, theme, graph);
    WorkflowService.setStyleToVertex('caseWhen', colorCode, theme, graph);
  ...
  createWorkflow(mainJson: any, editor: any, mapObj: any): void {
    ...
    function recursive(json: any, type: any, parent: any, path: string, versionId: string): void {
      if (json.instructions) {
        ...
        for (let x = 0; x < json.instructions.length; x++) {
          ...
          } else if (json.instructions[x].TYPE === 'Sleep') {
          ...
          } else if (json.instructions[x].TYPE === 'ImplicitEnd' || json.instructions[x].TYPE === 'CycleEnd' || json.instructions[x].TYPE === 'ForkListEnd' || json.instructions[x].TYPE === 'Join' || json.instructions[x].TYPE === 'WhenEnd' || json.instructions[x].TYPE === 'CaseEnd' || json.instructions[x].TYPE === 'ElseEnd') {
    ...
    function endWhen(x: any, target: any, parent: any): any {
    ...
    function endElse(branches: any, target: any, parent: any): any {
      const _node = doc.createElement('EndElse');
      _node.setAttribute('displayLabel', 'elseEnd');
      if (target.id) {
        _node.setAttribute('targetId', target.id);
      }
      ...
      if (branches.then && branches.then.instructions) {
        ...
        if (x) {
          ...
          flag = false;
          connectInstruction(endNode, v1, 'endElse', 'endElse', parent);
        }
      }
      if (flag) {
        connectInstruction(target, v1, '', '', parent);
    ...
    function joinForkListAndCycle(branches: any, targetId: any, parent: any, type: any): any {
      ...
      if (branches.instructions && branches.instructions.length > 0) {
        ...
        let pos;
        if ((x.TYPE === 'ImplicitEnd' || x.TYPE === 'CycleEnd' || x.TYPE === 'ForkListEnd' || x.TYPE === 'Join' || x.TYPE === 'endCase') && branches.instructions.length > 1) {
          pos = JSON.stringify(x.position);
          if (mapObj.vertixMap.has(pos)) {
            mapObj.vertixMap.set(pos, v1);
            const cell = vertexMap.get(x.uuid);
      ...
      if (cell.value.tagName === 'Process') {
        ...
        if (cell.value?.tagName === 'Connection') {
          if (x === 'then' || x === 'else') {
            ...
            str = x;
          } else if (cell.source?.value?.tagName === 'CaseWhen') {
            str = x;
          }
  ...
  isSingleInstruction(tagName: string): boolean {
    return (tagName === 'Job' || tagName === 'AddOrder' || tagName === 'Finish' || tagName === 'Fail' || tagName === 'Break' || tagName === 'Sleep' ||
