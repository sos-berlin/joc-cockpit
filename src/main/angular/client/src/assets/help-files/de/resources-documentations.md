...
- **Modifiziert** Datum der letzten Änderung.

### Operationen für Dokumentationen

Die folgenden Operationen sind über das Aktionsmenü einer Dokumentation verfügbar:

- **Dokumentation bearbeiten** ermöglicht die Änderung der referenzierten Datei.
- **Dokumentation ansehen** öffnet die Anwendung, der der entsprechende Mime-Type zugewiesen ist, um die Dokumentation anzuzeigen.
...
- mit **Dokumentation hochladen** können Sie eine Datei auswählen, die hochgeladen werden soll.
