...
- über die *Ordnertafel*, die eine Navigation zu den Berichtskonfigurationen bietet.
- über die *Berichtskonfigurationstafel*, die Details zur ausgewählten Berichtskonfiguration anzeigt.

### Ordner-Panel

Das Panel ermöglicht die Navigation durch die Bestandsordner, in denen die Berichtskonfigurationen gespeichert sind:

- Wenn Sie einen Ordner auswählen, werden die verfügbaren Berichtskonfigurationen in der *Berichtskonfigurationstafel* angezeigt.
- Wenn Sie für einen bestimmten Ordner auf das Symbol *Schrägstrich abwärts* klicken, werden die Berichtskonfigurationen im aktuellen Ordner und in den Unterordnern rekursiv angezeigt.
- Wenn Sie auf das Symbol *Aufwärtsblättern* klicken, wird der aktuelle Ordner geschlossen.

### Konfigurationspanel für Berichte
...
Berichte können über das 3-Punkte-Aktionsmenü einer Berichtskonfiguration mit der Operation *Berichte ausführen* erstellt werden.

Sie können eine Reihe von Berichtskonfigurationen auswählen und die Massenoperation *Berichte ausführen* anwenden, die über eine Schaltfläche in der oberen rechten Ecke des Bildschirms verfügbar ist.
