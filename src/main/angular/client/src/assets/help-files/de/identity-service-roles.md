...
- **Export** bietet eine Datei im JSON-Format zum Download an, die die Konfiguration der ausgewählten Rollen enthält. Die Exportdatei kann für den Import mit der gleichen oder einer anderen JOC Cockpit-Instanz verwendet werden.
