...
Wenn Sie eine Reihe von Berichten auswählen, können Sie über eine Schaltfläche in der rechten oberen Ecke des Bildschirms Berichte als Ganzes löschen.

## Anzeige von Berichten

Wenn Sie auf einen Bericht klicken, wird er für die *Berichtshäufigkeit* im angegebenen *Berichtszeitraum* wie folgt angezeigt:
