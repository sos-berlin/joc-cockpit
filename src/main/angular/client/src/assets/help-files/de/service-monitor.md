...
- überprüfung der Verfügbarkeit von JS7-Produkten und Meldung an die Unteransichten [Monitor - Controller Availability](/monitor-availability-controller) und [Monitor - Agent Availability](/monitor-availability-agent).
- überprüfung der angeschlossenen Controller und Agenten auf Warnungen und Fehler, die beim Betrieb der Produkte auftreten. Die Ergebnisse werden der Unteransicht [Monitor - System Notifications](/monitor-notifications-system) hinzugefügt.
- überprüfung der Ergebnisse der Ausführung von Arbeitsabläufen und Jobs von allen angeschlossenen Controllern und Hinzufügen von Benachrichtigungen zur Ansicht [Monitor - Order Notifications](/monitor-notifications-order).
