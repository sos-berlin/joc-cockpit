...
- **Frequenzen** gibt die *Berichtshäufigkeit* an, die den *Berichtszeitraum* in gleiche Einheiten unterteilt.
- **Anzahl der Berichte** zeigt die Anzahl der Berichte an, die für die Berichtskonfiguration erstellt wurden.
- **Fehlermeldung** zeigt den Fehler an, der auftritt, wenn der *Status* des Berichtslaufs *fehlerhaft* ist.
