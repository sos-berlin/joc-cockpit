...
- Ein Tagesplan kann Aufträge für ein bestimmtes Datum enthalten, die sich mit einem früheren oder späteren Tag überschneiden. Ein Beispiel,
  ...
  - angenommen, die Zeitzone des Zeitplans ist Asien/Kalkutta (UTC+05:30) und die Startzeit ist *23:00*,
...
- **Arbeitstagskalender** ist über eine gleichnamige Schaltfläche verfügbar und gibt die Tage an, für die Aufträge erstellt werden sollen. Bei wiederholter Verwendung fügt er Startzeiteinträge mit Zeiträumen pro Arbeitstagkalender hinzu.
...
- **Einzelner Start** ist ein einzelner Zeitpunkt.
  ...
  - **Bei Nicht-Arbeitstag** gibt an, was geschehen soll, wenn ein Zeitraum auf einen Tag trifft, der in einem Kalender für arbeitsfreie Tage angegeben ist.
    - **Ausführung verhindern** ist das Standardverhalten, um keine Aufträge zu erstellen.
    - **Nicht-Arbeitstag ignorieren** setzt den Nicht-Arbeitstag-Kalender außer Kraft und erstellt einen Auftrag.
    - **Vor Nicht-Arbeitstag** fügt einen Auftrag für den nächsten Arbeitstag vor dem arbeitsfreien Tag hinzu. Ein Beispiel:
      - Ein Arbeitstagkalender gibt Mo-Do für Arbeitstage an. 
    ...
    - **nach Nicht-Arbeitstag** fügt einen Auftrag zum nächsten Arbeitstag nach dem arbeitsfreien Tag hinzu. Ein Beispiel:
...
- **Wiederholen** gibt einen wiederholten Zeitraum für zyklische Aufträge an. Für die Eingabe wird die folgende Syntax verwendet: *HH:MM:SS*.
  ...
  - **Bei Nicht-Arbeitstag** gibt an, was geschehen soll, wenn eine Periode auf einen Tag trifft, der in einem Kalender für arbeitsfreie Tage angegeben ist. Die Konfiguration ist dieselbe wie für *Einzelner Start*.
...
- Zeitpläne können auch Verweise auf Kalender für arbeitsfreie Tage enthalten.
  ...
  - Wenn Benutzer bestimmte arbeitsfreie Tage aus dem Kalender ausschließen möchten, bevor die *Beschränkung* für den 4. des Monats angewandt wird, haben sie die Möglichkeit
    - die arbeitsfreien Tage aus den *Ausgeschlossenen Häufigkeiten* des Arbeitstagskalenders anzugeben.
