...
L'affichage est limité à un maximum de 5 000 entrées, sauf indication contraire sur [Profile - Preferences](/profile-preferences).

### Historique du Plan Quotidien

Les informations suivantes sont affichées pour chaque date du Plan Quotidien.

- **La date du Plan Quotidien** indique le jour pour lequel les Ordres sont planifiés.
- **Nombre total** indique le nombre d'Ordres soumis à toutes les soumissions pour la date donnée.
- **Le nombre de soumissions** indique le nombre d'Ordres soumis avec succès.
  ...
  - Si le nombre est supérieur à zéro mais inférieur au *Compte total*, alors
    - le paramètre permettant de soumettre les Ordres individuellement est en place, voir [Settings - Daily Plan](/settings-daily-plan) et
    - un certain nombre d'Ordres n'ont pas pu être soumis.
  - Si le nombre est égal à zéro, cela signifie que
    - le paramètre permettant de soumettre les Ordres individuellement n'est pas en place, voir [Settings - Daily Plan](/settings-daily-plan), et/ou
...
- **L'ID de l'Ordre** est l'identifiant unique attribué à l'Ordre.
...
- **Plannification** indique la date et l'heure auxquelles l'Ordre est censé commencer.
- **Le statut** est l'un des deux suivants : *Soumis* ou *Non soumis*.
...
- les boutons de filtre **Soumises**, **Non soumises** limitent l'affichage aux soumissions ayant le statut correspondant.
