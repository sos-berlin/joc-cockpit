...
- Le Contrôleur signale les connexions aux *agents stables* et aux *Agents Directeurs*. L'échec des connexions aux *Agents Directeurs* suggère que le Contrôleur ne connaît pas l'état des *Sous-Agents* dans le Cluster d'Agents qui est donc indiqué comme étant *inconnu*.
