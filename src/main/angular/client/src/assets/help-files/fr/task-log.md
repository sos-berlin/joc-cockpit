# Vue du Journal de Tâche

La vue *Journal de Tâche* offre un journal en cours d'exécution qui est mis à jour toutes les 2 ou 3 secondes. Cela permet de suivre les résultats des tâches en temps quasi réel.
...
Le *Journal d'Ordre* convertit les horodatages dans le fuseau horaire de l'utilisateur, si le paramètre correspondant dans le [Profile - Preferences](/profile-preferences) est actif. Sinon, c'est le fuseau horaire de l'Agent qui est utilisé.
