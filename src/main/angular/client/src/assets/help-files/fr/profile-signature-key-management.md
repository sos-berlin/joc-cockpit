...
L'onglet *Profil - Gestion de la clé de signature* contient le certificat de signature utilisé pour le déploiement des Workflows et des ressources de travail.
...
- l'option **Supprimer** supprime la clé privée et le certificat de signature. Dans les niveaux de sécurité *faible* et *moyen*, cela empêchera le déploiement des Workflows et des ressources de travail.
