...
- **État de l'Historique** indique si un transfert a été *réussi* ou *échec*.
...
- **L'ID de l'Ordre** est l'identifiant unique attribué à un Ordre.
...
- **Host** indique le nom d'hôte ou l'adresse IP du serveur.
