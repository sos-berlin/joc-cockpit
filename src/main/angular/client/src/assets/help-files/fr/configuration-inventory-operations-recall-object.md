...
Le rappel d'objets permet de les désactiver, par exemple, dans la vue [Daily Plan](/daily-plan). Cela s'applique aux objets tels que les Plannifications et les Calendriers disponibles dans le dossier système *Automation*.
