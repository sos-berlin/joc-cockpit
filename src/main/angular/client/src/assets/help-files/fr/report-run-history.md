# Historique de l'exécution du rapport
...
- **Report Template** indique le [Report Template](/report-templates) utilisé.
- **Status** indique l'une des valeurs suivantes : *running*, *successful*, *failed*.
...
- **Month From**, **Month To** indiquent le début et la fin de la *période de rapport*.
