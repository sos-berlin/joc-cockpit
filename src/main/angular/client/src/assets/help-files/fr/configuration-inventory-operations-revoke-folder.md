...
La révocation d'objets permet de les supprimer du contrôleur et de conserver les objets à l'état de projet dans l'inventaire. Cela s'applique aux objets tels que les Workflows et les ressources de travail disponibles dans le dossier système *Controller*.
...
Lorsque vous révoquez des objets d'un dossier en utilisant l'opération *Revoke* disponible dans le menu d'action à 3 points du dossier dans le panneau de navigation, une fenêtre contextuelle s'affiche comme suit :
...
La révocation d'objets tels que les Workflows et les ressources de travail a un impact sur le site [Daily Plan](/daily-plan). 
...
- Si une ressource d'emploi est référencée par un Workflow, la révocation de la ressource d'emploi entraîne également la révocation du Workflow.
