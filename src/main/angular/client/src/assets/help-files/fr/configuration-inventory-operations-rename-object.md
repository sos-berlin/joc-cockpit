...
L'opération *Renommer* est disponible à partir du panneau *Navigation* et est proposée pour les objets et les dossiers d'utilisateurs à partir de leur menu d'action à 3 points.
...
- Si une ressource d'emploi référencée par un Workflow est renommée, alors 
  ...
  - une opération *Deploy* ultérieure permettra d'assurer le déploiement commun des deux objets.
- Si un Workflow référencé par une Plannification est renommé, alors
  ...
  - une opération *Deploy* ultérieure sur le Workflow inclura une opération *Release* sur la Plannification et vice versa.
