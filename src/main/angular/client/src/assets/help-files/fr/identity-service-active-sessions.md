...
Les utilisateurs peuvent identifier les comptes détenant des sessions actives lorsqu'ils invoquent la vue *Gestion des services d'identité* à partir de l'icône de la roue dans la barre de menu.
