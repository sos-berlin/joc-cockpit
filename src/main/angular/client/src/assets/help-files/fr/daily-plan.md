...
- **Soumise** : Les opérations *laisser exécuter* et *annuler* peuvent être appliquées aux Ordres *soumis* au contrôleur et aux agents.
- **Finished** : L'opération *cancel* peut être appliquée aux ordres *soumis* au contrôleur et aux agents : L'opération *annuler* peut être appliquée aux Ordres qui se sont terminés.
...
- ordres en cours d'exécution **Let Run Ordres**
...
- **Copier les Ordres**
  ...
  - **Ignorer les heures d'admission des travaux** : Les travaux peuvent être limités à certains jours et/ou à certains créneaux horaires. Les ordres qui arrivent doivent attendre le prochain créneau horaire disponible. Cette option permet de forcer les travaux à démarrer indépendamment de ces limitations.
