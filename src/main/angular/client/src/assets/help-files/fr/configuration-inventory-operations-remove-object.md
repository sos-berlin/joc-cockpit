...
Lorsque vous supprimez un objet unique en utilisant l'opération *Supprimer* disponible dans le menu d'action à 3 points de l'objet dans le panneau de navigation, une fenêtre contextuelle s'affiche comme suit :
