...
- **Soumise** : L'opération *annuler* peut être appliquée aux Ordres *soumis* au contrôleur et aux agents.
- **Finished** : L'opération *annuler* peut être appliquée aux Ordres qui se sont terminés.
- **Late** est un filtre supplémentaire qui s'ajoute aux états des ordres et qui indique que les ordres ont été lancés plus tard que prévu.

### Annuler les Ordres

- Lorsqu'elle est appliquée aux Ordres *soumises* dans la plage de dates sélectionnée, les Ordres sont rappelés par le contrôleur et les agents.
- Lorsqu'elle est appliquée à des Ordres *soumises* ou *finies*, les Ordres seront remis à l'état *planifié*.
...
- L'opération est ignorée pour les Ordres *soumises* et *finies*.
...
- Pour les jours sélectionnés, le Plan Quotidien sera supprimé, à condition qu'aucun Ordre *soumis* ou *fini* ne soit disponible. Si des Ordres *planifiés* sont disponibles, ils seront abandonnés avec le Plan Quotidien.
