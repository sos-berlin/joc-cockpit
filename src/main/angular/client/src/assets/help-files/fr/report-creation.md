...
Cette vue permet de naviguer dans les dossiers d'inventaire qui contiennent les configurations de rapport :
...
### Vue de configuration des rapports
...
Les utilisateurs peuvent sélectionner un certain nombre de configurations de rapport et appliquer l'opération en bloc *Exécuter le Rapport* disponible à partir d'un bouton situé dans le coin supérieur droit de l'écran.
