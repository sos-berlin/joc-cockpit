...
- **JOC Cockpit ID** spécifie l'identifiant unique de l'instance du JOC Cockpit. 
...
- **L'agent limite l'affichage des notifications aux Ordres qui ont d'abord échoué, puis se sont rétablis en poursuivant avec succès le Workflow.
