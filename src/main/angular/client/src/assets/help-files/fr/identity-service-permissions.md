...
Les autorisations peuvent être considérées comme un arbre offrant une hiérarchie de branches. Le fait d'accorder ou de refuser des autorisations à un niveau supérieur entraîne l'attribution récursive d'autorisations à des niveaux plus profonds de l'arbre.
