...
- **Statut** indique si le déploiement a réussi ou échoué.
...
- **Nombre d'éléments** indique le nombre d'objets d'inventaire tels que les Workflows, les ressources de travail, etc. dans le champ d'application du déploiement.
...
- **Type d'objet** indique le type d'objet d'inventaire tel que *Workflow*, *Job Resource* etc.
- **Chemin d'accès** indique le dossier d'inventaire et le nom de l'objet. Pour les objets Workflow
  - en cliquant sur le nom du Workflow, vous accédez à la vue [Workflows](/workflows),
  - en cliquant sur l'icône du crayon, vous accédez à la vue [Configuration - Inventory - Workflows](/configuration-inventory-workflows).
- **L'opération** est l'une des deux options suivantes : *stocker* ou *supprimer*. Les deux opérations permettent de mettre à jour les objets.
