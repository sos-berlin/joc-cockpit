...
- **Le mot de passe** est disponible pour le type de service d'identité *JOC*. Le *mot de passe* sera haché avant d'être stocké dans la base de données. Lors de la connexion, une opération de hachage similaire est effectuée pour comparer les mots de passe. 
...
- la propriété **Confirmation du mot de passe** est utilisée pour répéter un *mot de passe* spécifié individuellement. Si la propriété *Mot de passe* est vide, la propriété *Confirmation du mot de passe* doit l'être également.
