# Paramètres - Cockpit JOC

Les paramètres suivants sont appliqués à JOC Cockpit. Les modifications prennent effet immédiatement.

La page *Paramètres* est accessible à partir de l'icône ![wheel icon](assets/images/wheel.png) dans la barre de menu.
...
### Setting : *default\_profile\_account*, Défaut : *root*
...
### Paramètres : *copy_paste\_suffix*, *copy\_paste\_prefix*, Défaut : *copy*
...
- Dans l'inventaire JS7, les noms d'objets sont uniques pour chaque type d'objet : par exemple, les Workflows utilisent des noms uniques, mais une ressource de travail peut utiliser le même nom qu'un Workflow.
...
### Paramètre : *import_suffix*, *import\_prefix*, Défaut : *importé*
...
Spécifie que dans les vues telles que *Workflows*, *Plan Quotidien*, *Ressources - Calendriers*, *Ressources - Verrous de ressources*, *Ressources - Tableaux d'affichage*, les noms des objets de planification et les chemins d'accès sont affichés. Si la valeur *false* est utilisée pour ce paramètre, le chemin est omis dans l'affichage des objets. Dans JS7, tous les noms d'objets sont uniques.
...
### Setting : *log_ext\_order\_history*
...
- **successful** : création d'un fichier historique pour les Ordres réussis.

### Setting : *log_ext\_order*
...
- **successful** : création d'un fichier journal de l'Ordre pour les Ordres réussis.

### Setting : *log_ext\_task*
...
- **successful** : crée un fichier journal pour les tâches réussies.

### Paramètre : *log_maximum\_display\_size*, Défaut : *10* MO
...
### Setting : *log_applicable\_size*, Défaut : *500* MO
...
### Setting : *log_maximum\_size*, Défaut : *1000* MO
...
Par défaut, les arguments spécifiés pour les travaux doivent contenir des valeurs, faute de quoi le Workflow est considéré comme invalide. Ce paramètre remplace le comportement par défaut et permet de spécifier des valeurs vides.
...
Indique le nombre de tags affichés avec chaque Ordre. La valeur 0 supprime l'affichage des étiquettes. Tenez compte du fait que l'affichage d'un grand nombre d'étiquettes par Ordre peut entraîner des pertes de performances.

### Paramètre : *num_of\_workflow\_tags\_displayed*, Valeur par défaut : *0*

Indique le nombre de balises affichées pour chaque Workflow. La valeur 0 supprime l'affichage des étiquettes.

## Paramètres d'approbation

### Paramètre : *approval_requestor\_role*

Indique le nom du rôle de demandeur auquel sont attribués les comptes soumis au processus d'approbation.

## Paramètres du rapport

### Paramètre : *report_java\_options*, Défaut : *-Xmx54M*
