...
Le service de nettoyage purgera le site [JS7 - Database](https://kb.sos-berlin.com/display/JS7/JS7+-+Database) des enregistrements périmés.
...
Pour chaque tâche exécutée au cours de la journée, une entrée dans l'"Historique des tâches" sera créée, de même pour l'"Historique des ordres". En fonction du nombre de travaux quotidiens, cela peut représenter un nombre considérable.
...
Le service de nettoyage est lancé en fonction de ses paramètres et il peut être lancé dans la vue du tableau de bord à partir du rectangle des instances actives du JOC Cockpit en proposant l'opération *Exécuter le service - Service de nettoyage*.

<img src="dashboard-run-cleanup-service.png" alt="Run Cleanup Service" width="750" height="280" />

## Paramètres du service de nettoyage

Pour plus de détails sur la configuration du Service de nettoyage, voir [Settings - Cleanup](/settings-cleanup).
