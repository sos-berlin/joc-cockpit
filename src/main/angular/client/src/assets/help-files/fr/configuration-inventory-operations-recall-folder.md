...
Lorsque vous rappelez des objets d'un dossier à l'aide de l'opération *Recall* disponible dans le menu d'action à 3 points du dossier dans le panneau de navigation, une fenêtre contextuelle s'affiche comme suit :
