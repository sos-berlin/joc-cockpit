...
Le panneau *Ordres* fournit des informations sur les Ordres provenant des sources suivantes :
...
Le panneau *Ordres* fournit des informations sur l'état actuel des Ordres. Le panneau est mis à jour lorsque l'état des Ordres change.
...
Le bouton déroulant situé dans le coin supérieur droit du panneau permet de sélectionner des Ordres dans une fourchette de dates :

- **Tous** affiche tous les Ordres disponibles auprès du contrôleur et des agents.
- **Today** Les Ordres sont liés à la journée en cours qui est calculée à partir du fuseau horaire de l'utilisateur [Profile - Preferences](/profile-preferences).
