...
Les modifications comprennent les objets d'inventaire tels que les Workflows, les Plannifications, etc. et les objets référencés, par exemple une ressource de tâche référencée par un Workflow.
...
La page *Gestion des modifications* permet d'ajouter, de mettre à jour et de supprimer des modifications.

## Liste des modifications

Les modifications existantes sont affichées dans une liste :
...
- **Status** est l'une des options suivantes : *Open* (ouvert) ou *Closed* (fermé). Les modifications fermées ne sont pas proposées pour les opérations de déploiement ou d'exportation.
...
## Opérations sur les modifications
