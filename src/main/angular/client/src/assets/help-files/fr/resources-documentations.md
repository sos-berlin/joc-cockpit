...
Les documentations sont référencées par les Workflows et les Jobs, et sont affichées avec la vue [Workflows](/workflows).

## Panneau de navigation

Le panneau de gauche affiche l'arborescence des dossiers d'inventaire contenant les documentations.
...
- **Type** est l'un des types supportés *Text*, *Markdwon*, *HTML*, *XML*, *PDF* etc.
