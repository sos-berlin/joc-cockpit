...
- La page [Configuration - Inventory - Navigation Panel](/configuration-inventory-navigation), sur le côté gauche de la fenêtre, permet de naviguer dans les dossiers contenant les Script Includes. En outre, cette vue permet d'effectuer des opérations sur les inclusions de scripts.
...
Le *search-literal* sera recherché dans le Script Include et sera remplacé par le *replacement-literal* lorsque le Workflow contenant la tâche associé sera déployé.
