...
- **Orange Ordres** : Ils indiquent les Ordres projetés qui sont calculés sur la base des règles d'heure de début.
- **Projection inversée** :
...
- Le bouton *Exporter* permet de sélectionner les Ordres à exporter :
  ...
  - **Workflows**, **Schedules** : Les utilisateurs peuvent limiter l'exportation à certaines Plannifications et à certains Workflow, éventuellement limités par des dossiers.
  - **Projection inversée** : 
