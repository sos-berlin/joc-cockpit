...
| ----- | ----- | ----- |
| Il s'agit d'un rôle technique sans aucune responsabilité dans les processus informatiques et commerciaux. | Ce rôle comprend toutes les autorisations pour démarrer, redémarrer, basculer, etc. les produits JS7. |
