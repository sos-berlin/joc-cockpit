...
- **Approbateur** est sélectionné dans la liste de [Approver Profiles](/approval-profiles). L'*Approbateur* indiqué sera de préférence notifié. Cependant, tout *Approbateur* peut approuver ou rejeter la demande d'autorisation.
- **Raison** fournit une explication à l'*Approbateur* sur la nécessité de l'intervention.

Lorsque la demande d'autorisation est soumise, elle devient visible dans la vue [Approval Requests](/approval-requests). L'*Approbateur* concerné recevra une notification par courrier électronique.
