...
La vue affiche des indicateurs de disponibilité des instances de l'agent.

Si une grappe d'agents est utilisée, la disponibilité de la grappe est prise en compte. Par exemple, si une instance d'agent dans un cluster est arrêtée à des fins de maintenance et que l'instance restante reprend la charge, cela ne réduit pas la disponibilité.
