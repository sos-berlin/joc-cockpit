...
- Les **agents Standalone** exécutent des tâches sur des machines distantes et à partir de conteneurs. Ils fonctionnent individuellement et sont gérés par le contrôleur.
- **Cluster d'agents
...
- Les connexions **l'Agent Standalone** et de l'**Agent Directeur** sont établies par le Contrôleur. 
