...
+function (a) {
  ...
  var d = function (a, b, c) {
            ...
            if (!this._isTransitioning && !a(this._element).hasClass(o.IN)) {
              ...
              if (this._parent && (d = a.makeArray(a(q.ACTIVES)), d.length || (d = null)), !(d && (e = a(d).data(g), e && e._isTransitioning))) {
                ...
                if (a(this._element).trigger(i), !i.isDefaultPrevented()) {
                  ...
                  var l = function () {
                    a(b._element).removeClass(o.COLLAPSING).addClass(o.COLLAPSE).addClass(o.IN), b._element.style[j] = "", b.setTransitioning(!1), a(b._element).trigger(n.SHOWN)
                  };
    ...
    var b = "dropdown", d = "4.0.0-alpha", g = "bs.dropdown", h = "." + g, i = ".data-api", j = a.fn[b], k = {
      ...
      return e(b, [{
        key: "toggle", value: function () {
          ...
          return a(c).trigger(g), !g.isDefaultPrevented() && (this.focus(), this.setAttribute("aria-expanded", "true"), a(c).toggleClass(l.OPEN), a(c).trigger(a.Event(k.SHOWN, f)), !1)
        }
      }, {
        key: "dispose", value: function () {
        ...
        return e(i, [{
          key: "refresh", value: function () {
            ...
            g.map(function (b) {
              ...
              if (g && (c = a(g)[0]), c && (c.offsetWidth || c.offsetHeight)) return [a(c)[d]().top + e, g]
            }).filter(function (a) {
              return a
            }).sort(function (a, b) {
              return a[0] - b[0]
    ...
    return a(window).on(m.LOAD_DATA_API, function () {
      ...
      a.fn[b].Constructor = q, a.fn[b].noConflict = function () {
